...
<?php } else { ?>
    <iframe src="http://server.energyfolks.com/affiliates/dashboard?aid=<?php echo get_option('energyfolks_affiliate_id'); ?>&iframe_next=true" width="1035" height="700" frameborder="0" border="0"></iframe>
    <?php } ?>
</div>
