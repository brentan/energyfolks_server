class DigestMailer < ActiveRecord::Base
  ...
  def items
    ...
    if (self.user.subscription.job_radius == 0) || (self.user.subscription.job_radius.blank?)
    ...
    if (self.user.subscription.event_radius == 0) || (self.user.subscription.event_radius.blank?)
